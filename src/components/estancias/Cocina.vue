...
const elementosCocinaOrganizados =
  obtenerElementosPorUbicacionOrganizados("cocina");
...
// Inicializar estados
Object.values(elementosCocinaOrganizados).forEach((categoria) => {
...
<template>
  ...
  >
    ...
    <div class="elementos-cocina mt-4">
      <h5 class="text-h6 mb-3">Elementos disponibles:</h5>

      <!-- Iteramos por cada categoría -->
      <div
        v-for="(elementos, nombreCategoria) in elementosCocinaOrganizados"
        :key="nombreCategoria"
