...
const nombresCategorias = {
  ...
  habitacion: "Elementos de Habitacion",
  baño: "Elementos de Baño",
};

// Obtener elementos del salón organizados por categorías
const elementosHabitacionOrganizados =
  obtenerElementosPorUbicacionOrganizados("habitacion");
...
// Inicializar estados
Object.values(elementosHabitacionOrganizados).forEach((categoria) => {
...
<template>
  ...
  >
    ...
    <div class="elementos-habitacion mt-4">
      <!-- Iteramos por cada categoría -->
      <div
        v-for="(elementos, nombreCategoria) in elementosHabitacionOrganizados"
        :key="nombreCategoria"
