...
const elementosSalonOrganizados =
  obtenerElementosPorUbicacionOrganizados("salon");
...
// Inicializar estados
Object.values(elementosSalonOrganizados).forEach((categoria) => {
...
<template>
  ...
  >
    ...
    <div class="elementos-salon mt-4">
      <h5 class="text-h6 mb-3">Elementos disponibles:</h5>

      <!-- Iteramos por cada categoría -->
      <div
        v-for="(elementos, nombreCategoria) in elementosSalonOrganizados"
        :key="nombreCategoria"
